...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		SanDiego = new UnfoldingMap(this, 50, 50, 350, 500, provider);

	    SanDiego.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));



		SanJose = new UnfoldingMap(this, 425, 50, 350, 500, provider);

		SanJose.zoomAndPanTo(zoomLevel, new Location(37.3f, -121.8f));
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, SanDiego);
		MapUtils.createDefaultEventDispatcher(this, SanDiego);
